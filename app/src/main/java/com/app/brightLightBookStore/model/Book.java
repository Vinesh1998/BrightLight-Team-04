...
public class Book {
    ...
    public Book(String id, String auth_name, String book_name, String image, Double purchase_amt, Double rental_amt, String shortDescription, String rating, String published, int count, int likes) {
        this.id = id;
        this.auth_name = auth_name;
        this.book_name = book_name;
