...
import static com.app.brightLightBookStore.helpers.common_helper.df;
...
public class MyBooksAdapter extends RecyclerView.Adapter<MyBooksAdapter.MyBook> {
    List<Book> list = Collections.emptyList();
    Context mContext;
    public MyBooksAdapter(List<Book> list, Context context){
        this.list = list;
    ...
    public MyBook onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyBooksAdapter.MyBook(v);
    }
