...
public class PaymentStatus extends AppCompatActivity {
    ...
    List<CartBook> books;
    String today_date = new SimpleDateFormat("MM-dd-yyyy", Locale.getDefault()).format(new Date());
    @Override
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    try {
                        ...
                        boolean status = ds.child("check").getValue(boolean.class);

                        if(user_id.equals(mAuth.getUid()) && status) {
                            ...
                            HistoryBook historyBook = new HistoryBook(dbKey,mAuth.getUid(),book_id,auth_name,
                                    book_name,image,purchase_amt,rental_amt, today_date,cart_qty,days, false);
